...
def add_args(parser):
    parser.add_argument("--task", type=str, required=False,
                        choices=['summarize', 'summarize_intent', 'refine', 'translate', 'concode', 'clone', 'defect', 'refine_intent'])
    ...
    parser.add_argument("--num_group", default=5, type=int,
                        help="Number of data group.")
    parser.add_argument("--data_type", default='code_only', type=str,
                        help="data type.")                          
